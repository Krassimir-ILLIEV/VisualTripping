...
var ToursService = (function () {
    function ToursService(http) {
        this.http = http;
        this.toursUrl = '/api/tours';
        this.toursUrlById = '/api/tours/';
    }
    ToursService.prototype.getAll = function () {
    ...
    ToursService.prototype.getTourDetailsById = function (id) {
    ...
    // };
    ToursService.prototype.handleError = function (error) {
